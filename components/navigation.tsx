...
export function Navigation({ isAuthenticated = false, userEmail, onLogout }: NavigationProps) {
  ...
  useEffect(() => {
    setPortalElement(typeof document !== "undefined" ? document.body : null)
  }, [])
            ...
            {mobileMenuOpen && (
              <>
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.3 }}
                  className="fixed inset-0 bg-black/70 z-[130] md:hidden"
                ...
                <motion.div
                  ...
                  className="fixed top-0 right-0 bottom-0 w-full max-w-sm z-[140] md:hidden shadow-2xl border-l border-border bg-white text-foreground"
                >
